...
document.getElementById("alert").style.justifyContent = "flex-start";


document.getElementById('signin_form').classList.add('onload1');  // For first time loading of page only
document.getElementById('lottieSignin').classList.add('onload2');
...
function switch_over1() {
    ...
    document.getElementById('signin_form').classList.remove('onload1');
    document.getElementById('lottieSignin').classList.remove('onload2');
}
